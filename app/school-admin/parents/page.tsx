...
export default async function ParentsPage(){
 ...
 return <PremiumShell schoolName={ctx.schoolName||"School Workspace"} userLabel="Administrator" roleLabel="School Admin" nav={nav}>
  <section className="hero"><div><h1>Parents & Guardians</h1><p>Manage guardian accounts and control exactly which students each parent is allowed to monitor.</p></div></section>
